      ...
      <div className="relative group">
        ...
        <button
          ...
          className={`
            ...
            w-12 h-12 rounded-full border shadow-xl
            transition-all duration-300
            ${
              isBeginning
                ? "bg-gray-100 text-gray-300 cursor-not-allowed"
                : "bg-white border-green-100 text-[#16A34A] hover:bg-[#16A34A] hover:text-white hover:scale-110"
            }
              ...
              >
                ...
                <div className="relative flex flex-col items-center px-6 pb-6">
                  ...
                  <a
                    ...
                    className="w-full flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-green-50"
                  >
                    <span>✉️</span>
